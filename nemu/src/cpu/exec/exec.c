...
extern make_EHelper(jmp_rm);
extern make_EHelper(shr);
extern make_EHelper(in);
extern make_EHelper(out);
...
extern make_EHelper(popa);
extern make_EHelper(iret);
extern make_EHelper(mov_r2cr);
extern make_EHelper(mov_cr2r);
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x1c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x20 */	/*IDEX(E2G,mov_r2cr)*/EMPTY, EMPTY, /*IDEX(G2E,mov_cr2r)*/EMPTY, EMPTY,
